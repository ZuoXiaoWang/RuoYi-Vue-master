<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="区域值" prop="areaValue">
        <el-input
          v-model="queryParams.areaValue"
          placeholder="请输入区域值"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="areaList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="区域值" align="center" prop="areaValue" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="区域值" prop="areaValue">
          <el-input v-model="form.areaValue" placeholder="请输入区域值" />
        </el-form-item>
      </el-form>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        areaValue: [
          { required: true, message: "区域值不能为空", trigger: "blur" }
        ]
      }
    };
  },
