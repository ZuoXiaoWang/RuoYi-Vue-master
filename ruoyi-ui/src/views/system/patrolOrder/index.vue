  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="110px">
      ...
      <el-form-item label="巡更结果" prop="patrolResult">
        <el-select v-model="queryParams.patrolResult" placeholder="巡更结果" clearable>
          <el-option
  ...
  data() {
    return {
      ...
      rules: {
        ...
        patrolId: [
          { required: true, message: "巡更任务编号不能为空", trigger: "blur" }
        ],
        patrolName: [
          { required: true, message: "巡更任务名称不能为空", trigger: "blur" }
        ],
        personnelId: [
          { required: true, message: "巡更人编号不能为空", trigger: "blur" }
        ],
        personnelName: [
          { required: true, message: "巡更人姓名不能为空", trigger: "blur" }
        ],
        patrolResult: [
          { required: true, message: "巡更结果不能为空", trigger: "blur" }
        ],
      }
    };
  },
