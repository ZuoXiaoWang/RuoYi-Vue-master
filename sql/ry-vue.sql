...
INSERT INTO `sys_config` VALUES (5, '账号自助-是否开启用户注册功能', 'sys.account.registerUser', 'true', 'Y', 'admin', '2023-03-24 14:39:22', 'admin', '2023-03-24 15:04:53', '是否开启注册用户功能（true开启，false关闭）');
...
INSERT INTO `sys_menu` VALUES (2, '系统监控', 0, 4, 'monitor', NULL, '', 1, 0, 'M', '0', '0', '', 'monitor', 'admin', '2023-03-24 14:38:51', 'admin', '2023-03-27 14:07:38', '系统监控目录');
INSERT INTO `sys_menu` VALUES (3, '系统工具', 0, 4, 'tool', NULL, '', 1, 0, 'M', '0', '0', '', 'tool', 'admin', '2023-03-24 14:38:51', 'admin', '2023-03-27 14:07:56', '系统工具目录');
INSERT INTO `sys_menu` VALUES (4, '若依官网', 0, 4, 'http://ruoyi.vip', NULL, '', 0, 0, 'M', '1', '0', '', 'guide', 'admin', '2023-03-24 14:38:51', 'admin', '2023-03-27 14:07:13', '若依官网地址');
...
INSERT INTO `sys_menu` VALUES (2006, '巡更管理', 0, 2, 'patrol', NULL, NULL, 1, 0, 'M', '0', '0', NULL, 'time-range', 'admin', '2023-03-27 14:04:13', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2007, '维修管理', 0, 3, 'repair', NULL, NULL, 1, 0, 'M', '0', '0', NULL, 'validCode', 'admin', '2023-03-27 14:06:39', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2008, '员工管理', 1, 1, 'personnel', 'system/personnel/index', NULL, 1, 0, 'C', '0', '0', 'system:personnel:list', '#', 'admin', '2023-03-27 15:58:09', '', NULL, '员工管理菜单');
...
) ENGINE = InnoDB AUTO_INCREMENT = 151 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `sys_personnel` VALUES (1, 103, 4, '123', '', 'ceshi', NULL, '0', '0', NULL, NULL, NULL, '', NULL, '', '2023-03-27 16:02:33');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '192.168.0.9', '2023-03-27 16:00:56', 'admin', '2023-03-24 14:38:48', '', '2023-03-27 16:00:54', '管理员');
...
INSERT INTO `sys_user` VALUES (100, NULL, '912996618', '912996618', '00', '', '18232005950', '0', '', '$2a$10$XJZA3HYVm4UP8YkUP0RkfejY/Tl7AbCddfw/ua9FkvmvO7vv1rYRq', '0', '0', '127.0.0.1', '2023-03-24 15:17:43', '', '2023-03-24 15:16:51', '', '2023-03-24 15:17:40', NULL);
